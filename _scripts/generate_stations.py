...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    @media(max-width:700px){{.stats-grid{{grid-template-columns:repeat(3,1fr);gap:8px}}}}
    @media(max-width:420px){{
      .stats-grid{{grid-template-columns:repeat(3,1fr);gap:6px}}
      .stat-box{{padding:10px 4px}}
      .stat-val{{font-size:1.05rem}}
      .stat-lbl{{font-size:.56rem;letter-spacing:.02em;margin-top:3px}}
    }}
    ...
    /* ONGLETS — style "menu souligné", plus visible et plus aéré */
    .tab-nav-wrap{{position:relative;border-radius:14px 14px 0 0;background:white;border:1px solid var(--border);border-bottom:2px solid var(--wood-pale);overflow:hidden}}
    .tab-nav{{display:flex;gap:2px;margin-bottom:0;flex-wrap:nowrap;max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;background:white;border-radius:14px 14px 0 0;padding:0 8px}}
    .tab-nav::-webkit-scrollbar{{display:none}}
    .tab-nav-wrap::after{{content:'';position:absolute;top:0;right:0;bottom:0;width:32px;background:linear-gradient(to right,transparent,white 75%);border-radius:0 14px 0 0;pointer-events:none;opacity:1;transition:opacity .2s}}
    .tab-nav-wrap.scrolled-end::after{{opacity:0}}
    .tab-btn{{flex:0 0 auto;padding:17px 16px 14px;border:none;background:transparent;cursor:pointer;font-family:"DM Sans",sans-serif;font-size:.9rem;font-weight:700;color:var(--text-light);transition:color .15s,border-color .15s;letter-spacing:.005em;white-space:nowrap;border-bottom:3px solid transparent;margin-bottom:-2px}}
    ...
    .tab-content{{display:none;background:white;border:1px solid var(--border);border-top:none;border-radius:0 0 14px 14px;padding:28px 24px;min-height:200px}}
    ...
    /* SECTIONS */
    .section{{background:var(--white);border-radius:var(--radius);padding:26px 24px;min-width:0;margin-bottom:20px;box-shadow:0 2px 10px rgba(0,0,0,.05);border:1px solid var(--wood-light)}}
    .section-title{{font-family:"DM Serif Display",serif;font-size:1.1rem;color:var(--text-mid);margin-bottom:20px;padding-bottom:12px;border-bottom:2px solid var(--wood-pale)}}
    ...
    <div>
      ...
      <div class="tab-content active" id="tab-infos">
        ...
        <div class="section">
          ...
          <p style="font-size:.9rem;line-height:1.9;color:var(--text-mid)">{desc_long}</p>
        ...
        <div class="section" style="margin-bottom:0">
          ...
          <p style="font-size:.87rem;line-height:1.85;color:var(--text-mid)">
