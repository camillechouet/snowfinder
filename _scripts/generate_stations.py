...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .hero-link-card{{pointer-events:auto;position:relative;width:210px;border-radius:15px;overflow:hidden;text-decoration:none;display:block;box-shadow:0 8px 24px rgba(0,0,0,.4);border:2px solid rgba(212,175,55,.7);background:#0d3a6e;transition:transform .15s,box-shadow .15s}}
    .hero-link-card:hover{{transform:translateY(-2px);box-shadow:0 12px 30px rgba(0,0,0,.48)}}
    .hero-link-card img{{width:100%;height:84px;object-fit:cover;display:block;opacity:.8}}
    .hero-link-card-overlay{{position:absolute;inset:0;background:linear-gradient(to top,rgba(9,26,49,.96) 0%,rgba(9,26,49,.32) 62%,rgba(9,26,49,.05) 100%);display:flex;flex-direction:column;justify-content:flex-end;padding:10px 14px 12px}}
    .hero-link-card-tag{{font-size:.62rem;text-transform:uppercase;letter-spacing:.07em;color:#e4c766;font-weight:800;margin-bottom:2px}}
    .hero-link-card-name{{font-family:"DM Serif Display",serif;font-size:1.12rem;color:white;line-height:1.2;display:flex;align-items:center;gap:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}}
    .hero-link-card-name span{{font-size:.9rem;color:#e4c766;flex-shrink:0}}
    @media(max-width:400px){{
      .hero-link-card{{width:158px}}
      .hero-link-card img{{height:66px}}
      .hero-link-card-name{{font-size:.94rem}}
    }}
    ...
    .domaine-box{{
      ...
      position:relative;height:150px;border:1px solid #0d3a6e;
    ...
    .domaine-box-overlay{{position:absolute;inset:0;background:linear-gradient(120deg,rgba(9,26,49,.9) 0%,rgba(13,58,110,.5) 55%,rgba(13,58,110,.25) 100%);display:flex;flex-direction:column;justify-content:center;padding:20px 26px}}
    .domaine-box-tag{{font-size:.72rem;font-weight:800;text-transform:uppercase;letter-spacing:.07em;color:#e4c766;margin-bottom:5px}}
    .domaine-box-name{{font-family:"DM Serif Display",serif;font-size:1.55rem;color:#fff;display:flex;align-items:center;gap:9px;text-shadow:0 2px 10px rgba(0,0,0,.35)}}
    .domaine-box-arrow{{font-size:1.2rem;color:#e4c766}}
