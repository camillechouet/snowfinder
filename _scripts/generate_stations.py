      ...
      <div class="tab-content" id="tab-neige">
        ...
        <div class="section" style="margin-bottom:0">
          ...
          <p style="font-size:.88rem;line-height:1.72;color:var(--text-mid)">
            ...
            {'Au-dessus de 2 000 m, la neige est généralement garantie de mi-décembre à fin mars.' if s['alt_max'] >= 2000 else
             'À cette altitude, l\'enneigement dépend des conditions de l\'année. Vérifiez l\'état des pistes avant de partir.' if s['alt_max'] >= 1500 else
             'L\'altitude modérée rend l\'enneigement sensible aux variations climatiques. Privilégiez les mois de janvier-février.'}
          </p>
