...
_ALT_VILLAGE = {
    ...
    "Samoëns":720,"Morillon":700,"Les Carroz":1140,"Flaine":1600,
    "Megève":1113,"Saint-Gervais":850,"Les Contamines-Montjoie":1164,"Combloux":1000,
    "Val Thorens":2300,"Les Menuires":1800,"Saint-Martin-de-Belleville":1450,
    "Méribel":1450,"La Tania":1350,"Courchevel":1850,
    "Val d'Isère":1850,"Tignes":2100,
    "La Plagne":1970,"Peisey-Vallandry":1600,"Les Arcs":1800,
    "Alpe d'Huez":1860,"Serre Chevalier":1350,"Montgenèvre":1860,
    "Vars":1850,"Risoul":1850,"Saint-Lary-Soulan":1680,"La Rosière":1850,
}
...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .domaine-box-stats>div{{text-align:center;padding:12px 6px}}
    .dbs-val{{font-family:"DM Serif Display",serif;font-size:1.15rem;color:#5c3d00;line-height:1.1}}
    .dbs-lbl{{font-size:.63rem;color:#a0720a;text-transform:uppercase;letter-spacing:.04em;margin-top:3px}}
    .domaine-box-foot{{padding:10px 20px;font-size:.76rem;color:#a0720a;font-weight:600}}
    @media(max-width:480px){{.domaine-box-stats{{grid-template-columns:repeat(2,1fr)}}}}
