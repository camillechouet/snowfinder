...
{carousel_dots_html}
    ...
    if domaine:
        ...
        alt_max_lbl = "Sommet" if s['name'] in domaine.get('alt_max_propre', {}) else "Sommet (domaine)"
        ...
        elif _km_p and domaine.get('km_total'):
...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  ...
  .dm-stations-grid{{display:grid;grid-template-columns:1fr;gap:14px}}
