...
DOMAINE_PARTAGE = {
    ...
    "Schladming": "Schladming 4-Berge-Skischaukel",
    "Haus im Ennstal": "Schladming 4-Berge-Skischaukel",
    "Pichl – Reiteralm": "Schladming 4-Berge-Skischaukel",
    "Schruns": "Silvretta Montafon",
    "St. Gallenkirch": "Silvretta Montafon",
    "Gaschurn": "Silvretta Montafon",
    "Damüls": "Damüls – Mellau",
    "Mellau": "Damüls – Mellau",
    "Saalbach": "Skicircus Saalbach Hinterglemm Leogang Fieberbrunn",
    "Hinterglemm": "Skicircus Saalbach Hinterglemm Leogang Fieberbrunn",
    "Leogang": "Skicircus Saalbach Hinterglemm Leogang Fieberbrunn",
    "Fieberbrunn": "Skicircus Saalbach Hinterglemm Leogang Fieberbrunn",
    ...
    "Bad Gastein": "Schlossalm – Stubnerkogel (Bad Gastein – Bad Hofgastein)",
    "Bad Hofgastein": "Schlossalm – Stubnerkogel (Bad Gastein – Bad Hofgastein)",
    "Dorfgastein": "Dorfgastein – Großarl",
    "Großarl": "Dorfgastein – Großarl",
}
...
DOMAINES = {
    ...
    "skicircus": {
        "name": "Skicircus Saalbach Hinterglemm Leogang Fieberbrunn", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Saalbach", "Hinterglemm", "Leogang", "Fieberbrunn"],
        "km_propre": {},
        "km_total": 270, "remontees_total": 69, "forfait_domaine": 82,
        "alt_min": 830, "alt_max": 2096,
        "unifie": True,
        "pistes": {"v": 0, "b": 52, "r": 41, "n": 7, "pct": 1},
        "short": "Skicircus",
        "desc": "Le Skicircus relie Saalbach, Hinterglemm et Leogang, dans le Land de Salzbourg, à Fieberbrunn, au Tyrol : 270 km de pistes, l'un des plus grands domaines d'Autriche, réputé pour son ambiance après-ski. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "snow-space-salzburg": {
        "name": "Snow Space Salzburg", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Flachau", "Wagrain", "St. Johann-Alpendorf"],
        "km_propre": {},
        "km_total": 120.1, "remontees_total": 43, "forfait_domaine": 75,
        "alt_min": 740, "alt_max": 1980,
        "unifie": True,
        "pistes": {"v": 0, "b": 28, "r": 69, "n": 3, "pct": 1},
        "short": "Snow Space Salzburg",
        "desc": "Snow Space Salzburg relie Flachau, Wagrain et St. Johann-Alpendorf sur 120 km de pistes, surtout rouges, au cœur du réseau Ski amadé. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "hochkoenig": {
        "name": "Hochkönig", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Maria Alm", "Dienten", "Mühlbach am Hochkönig"],
        "km_propre": {},
        "km_total": 120, "remontees_total": 34, "forfait_domaine": 79,
        "alt_min": 800, "alt_max": 1900,
        "unifie": True,
        "pistes": {"v": 0, "b": 43, "r": 35, "n": 22, "pct": 1},
        "short": "Hochkönig",
        "desc": "Le domaine du Hochkönig relie Maria Alm, Dienten et Mühlbach sur 120 km de pistes, au pied du massif du Hochkönig. Le circuit de la Königstour permet d'en faire le tour dans la journée. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "gastein": {
        "name": "Schlossalm – Stubnerkogel (Bad Gastein – Bad Hofgastein)", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Bad Gastein", "Bad Hofgastein"],
        "km_propre": {},
        "km_total": 82.7, "remontees_total": 17, "forfait_domaine": 79,
        "alt_min": 860, "alt_max": 2300,
        "unifie": True,
        "pistes": {"v": 0, "b": 37, "r": 60, "n": 3, "pct": 1},
        "short": "Schlossalm – Stubnerkogel",
        "desc": "Les domaines de la Schlossalm, de l'Angertal et du Stubnerkogel relient Bad Hofgastein à Bad Gastein sur 83 km de pistes, dans la vallée thermale de Gastein. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "dorfgastein-grossarl": {
        "name": "Dorfgastein – Großarl", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Dorfgastein", "Großarl"],
        "km_propre": {},
        "km_total": 67.5, "remontees_total": 16, "forfait_domaine": 82,
        "alt_min": 849, "alt_max": 2033,
        "unifie": True,
        "pistes": {"v": 0, "b": 46, "r": 52, "n": 2, "pct": 1},
        "short": "Dorfgastein – Großarl",
        "desc": "Le domaine de Dorfgastein et Großarl relie les deux vallées par le Kreuzkogel, sur 67 km de pistes surtout bleues et rouges. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "silvretta-montafon": {
        "name": "Silvretta Montafon", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Schruns", "St. Gallenkirch", "Gaschurn"],
        "km_propre": {},
        "km_total": 141.6, "remontees_total": 35, "forfait_domaine": 77,
        "alt_min": 700, "alt_max": 2430,
        "unifie": True,
        "pistes": {"v": 0, "b": 42, "r": 36, "n": 22, "pct": 1},
        "short": "Silvretta Montafon",
        "desc": "Silvretta Montafon relie Schruns, St. Gallenkirch et Gaschurn sur 142 km de pistes, le plus grand domaine du Vorarlberg, réputé pour son hors-piste. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "damuels-mellau": {
        "name": "Damüls – Mellau", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Damüls", "Mellau"],
        "km_propre": {},
        "km_total": 75.8, "remontees_total": 21, "forfait_domaine": 73,
        "alt_min": 710, "alt_max": 2050,
        "unifie": True,
        "pistes": {"v": 0, "b": 39, "r": 58, "n": 3, "pct": 1},
        "short": "Damüls – Mellau",
        "desc": "Le domaine de Damüls et Mellau, le plus grand du Bregenzerwald, relie les deux villages sur 76 km de pistes, dans une région réputée pour ses chutes de neige abondantes. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
    "schladming-4-berge": {
        "name": "Schladming 4-Berge-Skischaukel", "massif": "Alpes du Nord", "pays": ["Autriche"],
        "stations": ["Schladming", "Haus im Ennstal", "Pichl – Reiteralm"],
        "km_propre": {},
        "km_total": 123, "remontees_total": 47, "forfait_domaine": 79,
        "alt_min": 728, "alt_max": 2015,
        "unifie": True,
        "pistes": {"v": 0, "b": 38, "r": 55, "n": 7, "pct": 1},
        "short": "4-Berge-Skischaukel",
        "desc": "La 4-Berge-Skischaukel relie la Reiteralm, la Hochwurzen, la Planai et le Hauser Kaibling sur 123 km de pistes, le plus grand domaine de Styrie, au cœur du réseau Ski amadé. La répartition des pistes est donnée en pourcentage des kilomètres par difficulté.",
    },
}
...
_ALT_VILLAGE = {
    ...
    "St. Anton am Arlberg":1304,"St. Christoph":1800,"Stuben":1407,"Lech":1450,"Zürs":1717,"Warth-Schröcken":1495,"Söll":703,"Ellmau":804,"Scheffau":752,"Going":773,"Brixen im Thale":794,"Westendorf":784,"Hopfgarten":622,"Ischgl":1377,"Kitzbühel":762,"Kirchberg in Tirol":837,"Serfaus":1427,"Fiss":1438,"Ladis":1190,"Zell am Ziller":580,"Gerlos":1245,"Königsleiten":1600,"Hochkrimml":1650,"Mayrhofen":630,"Finkenberg":840,"Alpbach":975,"Wildschönau":870,"Kaltenbach":560,"Hochfügen":1480,"Waidring":778,"Schladming":745,"Haus im Ennstal":750,"Pichl – Reiteralm":850,"Schruns":690,"St. Gallenkirch":878,"Gaschurn":979,"Damüls":1431,"Mellau":688,"Saalbach":1003,"Hinterglemm":1060,"Leogang":800,"Fieberbrunn":790,"Flachau":925,"Wagrain":838,"St. Johann-Alpendorf":800,"Maria Alm":802,"Dienten":1071,"Mühlbach am Hochkönig":853,"Bad Gastein":1002,"Bad Hofgastein":860,"Dorfgastein":830,"Großarl":924,
}
...
OFFICIAL_URLS = {
    ...
    # AUTRICHE — TYROL (fin)
    "Hochkössen":                   "https://www.hochkoessen.at",
    "Buchensteinwand":              "https://www.bergbahn-pillersee.at",
    "Zettersfeld":                  "https://www.lienzer-bergbahnen.at",
    "Fügen – Spieljoch":            "https://www.spieljochbahn.at",
    "Seefeld – Rosshütte":          "https://www.seefeld.com",
    "Patscherkofel":                "https://www.patscherkofelbahn.at",
    "Kitzbüheler Horn":             "https://www.kitzski.at",
    "Muttereralm":                  "https://www.muttereralm.at",
    "Reutte – Hahnenkamm":          "https://www.reuttener-seilbahnen.at",
    "Vent":                         "https://www.vent.at",
    "Venet":                        "https://www.venet.at",
    "Kellerjoch":                   "https://www.kellerjochbahn.at",
    "Nordkette":                    "https://www.nordkette.com",
    "Obertilliach":                 "https://www.obertilliach.at",
    "Pertisau – Karwendel":         "https://www.karwendel-bergbahn.at",
    "Biberwier":                    "https://www.zugspitzarena.com",
    "Maurach – Rofan":              "https://www.rofanseilbahn.at",
    "Hoch-Imst":                    "https://www.hoch-imst.at",
    # AUTRICHE — SALZBOURG
    "Saalbach":                     "https://www.saalbach.com",
    "Hinterglemm":                  "https://www.saalbach.com",
    "Leogang":                      "https://www.saalfelden-leogang.com",
    "Fieberbrunn":                  "https://www.saalbach.com",
    "Flachau":                      "https://www.snow-space.com",
    "Wagrain":                      "https://www.snow-space.com",
    "St. Johann-Alpendorf":         "https://www.snow-space.com",
    "Maria Alm":                    "https://www.hochkoenig.at",
    "Dienten":                      "https://www.hochkoenig.at",
    "Mühlbach am Hochkönig":        "https://www.hochkoenig.at",
    "Bad Gastein":                  "https://www.gastein.com",
    "Bad Hofgastein":               "https://www.gastein.com",
    "Dorfgastein":                  "https://www.gastein.com",
    "Großarl":                      "https://www.grossarltal.info",
    "Kaprun":                       "https://www.kitzsteinhorn.at",
    "Zell am See":                  "https://www.schmitten.at",
    "Obertauern":                   "https://www.obertauern.com",
    "Wildkogel (Neukirchen – Bramberg)":"https://www.wildkogel-arena.at",
    "Zauchensee":                   "https://www.zauchensee.at",
    "Lofer":                        "https://www.lofer.com",
    "Mauterndorf – Grosseck-Speiereck":"https://www.grosseck-speiereck.at",
    "Dachstein West":               "https://www.dachstein-west.at",
    "Rauris":                       "https://www.raurisertal.at",
    "Werfenweng":                   "https://www.werfenweng.eu",
    "Kleinarl – Shuttleberg":       "https://www.shuttleberg.com",
    "Fanningberg":                  "https://www.fanningberg.info",
    "Uttendorf – Weissee":          "https://www.weissee.at",
    "Filzmoos":                     "https://www.filzmoos.at",
    "Sportgastein":                 "https://www.gastein.com",
    "Radstadt – Altenmarkt":        "https://www.radstadt.com",
    "Forstau – Fageralm":           "https://www.fageralm.at",
    "Unken – Heutal":               "https://www.unken.at",
    # AUTRICHE — VORARLBERG
    "Schruns":                      "https://www.silvretta-montafon.at",
    "St. Gallenkirch":              "https://www.silvretta-montafon.at",
    "Gaschurn":                     "https://www.silvretta-montafon.at",
    "Damüls":                       "https://www.damuels-mellau.at",
    "Mellau":                       "https://www.damuels-mellau.at",
    "Brand – Brandnertal":          "https://www.brandnertal.at",
    "Golm":                         "https://www.golm.at",
    "Gargellen":                    "https://www.gargellen.at",
    "Schoppernau – Diedamskopf":    "https://www.diedamskopf.at",
    "Mittelberg – Walmendingerhorn":"https://www.ok-bergbahnen.com",
    "Ifen (Kleinwalsertal)":        "https://www.ok-bergbahnen.com",
    "Sonnenkopf (Klösterle)":       "https://www.sonnenkopf.at",
    "Laterns – Gapfohl":            "https://www.laterns.at",
    "Bödele":                       "https://www.boedele.at",
    "Schetteregg":                  "https://www.schetteregg.at",
    "Hochhäderich":                 "https://www.hochhaederich.at",
    # AUTRICHE — STYRIE, CARINTHIE, HAUTE ET BASSE-AUTRICHE
    "Schladming":                   "https://www.planai.at",
    "Haus im Ennstal":              "https://www.hauser-kaibling.at",
    "Pichl – Reiteralm":            "https://www.reiteralm.at",
    "Tauplitz":                     "https://www.dietauplitz.com",
    "Turracher Höhe":               "https://www.turracherhoehe.at",
    "Kreischberg":                  "https://www.kreischberg.at",
    "Altaussee – Loser":            "https://www.loser.at",
    "Riesneralm":                   "https://www.riesneralm.at",
    "Lachtal":                      "https://www.lachtal.at",
    "Spital am Semmering – Stuhleck":"https://www.stuhleck.com",
    "Präbichl":                     "https://www.praebichl.at",
    "Planneralm":                   "https://www.planneralm.at",
    "St. Lambrecht – Grebenzen":    "https://www.grebenzen.at",
    "Pruggern – Galsterberg":       "https://www.galsterberg.at",
    "Obdach – Rieseralm":           "https://www.rieseralm.at",
    "Ramsau am Dachstein – Rittisberg":"https://www.ramsau.com",
    "Niederalpl":                   "https://www.niederalpl.at",
    "Hirschegg – Salzstiegl":       "https://www.salzstiegl.at",
    "Mariazell – Bürgeralpe":       "https://www.buergeralpe.at",
    "Hohentauern":                  "https://www.hohentauern.at",
    "Veitsch – Brunnalm":           "https://www.brunnalm.at",
    "Nassfeld":                     "https://www.nassfeld.at",
    "Bad Kleinkirchheim":           "https://www.badkleinkirchheim.at",
    "Katschberg":                   "https://www.katschberg.at",
    "Heiligenblut":                 "https://www.heiligenblut.at",
    "Gerlitzen":                    "https://www.gerlitzen.com",
    "Mölltaler Gletscher":          "https://www.gletscher.co.at",
    "Klippitztörl":                 "https://www.klippitztoerl.at",
    "Spittal – Goldeck":            "https://www.goldeck.at",
    "Hochrindl":                    "https://www.hochrindl.at",
    "Koralpe":                      "https://www.koralpe.at",
    "Weinebene":                    "https://www.weinebene.at",
    "Petzen":                       "https://www.petzen.net",
    "St. Urban – Simonhöhe":        "https://www.simonhoehe.at",
    "Arnoldstein – Dreiländereck":  "https://www.dreilaendereck.at",
    "Mallnitz – Ankogel":           "https://www.ankogel.at",
    "Flattnitz – Hirnkopf":         "https://www.flattnitz.at",
    "Falkert – Heidialm":           "https://www.heidialm.at",
    "Hinterstoder – Höss":          "https://www.hiwu.at",
    "Grünau – Kasberg":             "https://www.kasberg.at",
    "Spital am Pyhrn – Wurzeralm":  "https://www.hiwu.at",
    "Hochficht":                    "https://www.hochficht.at",
    "Obertraun – Krippenstein":     "https://www.dachstein-salzkammergut.com",
    "Ebensee – Feuerkogel":         "https://www.feuerkogel.net",
    "Göstling – Hochkar":           "https://www.hochkar.com",
    "Unterberg":                    "https://www.unterberg.at",
    "Lackenhof – Ötscher":          "https://www.oetscher.at",
    "Mitterbach – Gemeindealpe":    "https://www.gemeindealpe.at",
    "Semmering – Zauberberg":       "https://www.zauberberg.at",
    "Mönichkirchen – Mariensee":    "https://www.schischaukel.net",
    "Annaberg":                     "https://www.annaberg.info",
    # SLOVÉNIE
    "Maribor – Pohorje":            "https://www.pohorje.org",
    "Krvavec":                      "https://www.rtc-krvavec.si",
    "Vogel":                        "https://www.vogel.si",
    "Kranjska Gora":                "https://www.kranjska-gora.si",
    "Cerkno":                       "https://www.ski-cerkno.com",
    "Rogla":                        "https://www.rogla.eu",
    "Golte":                        "https://www.golte.si",
    "Stari vrh":                    "https://www.starivrh.si",
}
...
{carousel_dots_html}
    ...
    if domaine:
        ...
        # Bandeau photo simple — juste le nom + lien vers la fiche complète, sans les chiffres
        # (les chiffres sont déjà dans la carte "Aperçu du domaine skiable" juste en dessous)
        domaine_highlight_box = f'''<a href="{domaine_url}" class="domaine-box">
    <img src="{_dm_photo}" alt="{domaine['name']}" loading="lazy">
    <div class="domaine-box-overlay">
    ...
    <div class="hero-link-card-overlay">
      ...
      <div class="hero-link-card-name">{domaine["short"]} <span>→</span></div>
        ...
        # Vignettes des autres stations du domaine — photo de la station concernée en fond
        # (photo perso si dispo, sinon placeholder déterministe — jamais de fond vide)
        def _soeur_photo(n):
            sp = get_station_photos(n)
            return sp[0] if sp else pick_placeholder(n, massif=domaine.get('massif'), w=600)
        soeurs_cards = "\n".join(
            f'''<a href="{slugify(n)}.html" class="domaine-soeur-card">
        <img src="{_soeur_photo(n)}" alt="{n}" loading="lazy">
        <div class="domaine-soeur-overlay">
    ...
    if domaine and photo_is_placeholder:
        hero_illu_note = '<div class="hero-illu-note" style="bottom:112px">Photo d\'illustration</div>'
    ...
    _bk_pays = {"ES": "espagne", "AD": "andorre", "CH": "suisse", "IT": "italie", "DE": "allemagne", "LI": "liechtenstein", "AT": "autriche", "SI": "slovenie"}.get(s.get('pays'), "france")
...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .hero-content{{position:absolute;bottom:0;left:0;right:0;padding:28px 194px 32px 28px;z-index:10;pointer-events:none}}
    @media(max-width:400px){{.hero-content{{padding-right:154px}}}}
    .hero-massif{{
    ...
    /* Vignette "Grand domaine" — en bas à droite. Le padding-droit de .hero-content
       (ci-dessus) réserve toujours assez de place pour qu'elle ne chevauche jamais
       le titre / la région, quelle que soit la largeur d'écran. */
    .hero-link-card{{position:absolute;bottom:14px;right:14px;z-index:12;pointer-events:auto;width:168px;border-radius:14px;overflow:hidden;text-decoration:none;display:block;box-shadow:0 8px 22px rgba(0,0,0,.4);border:2px solid rgba(212,175,55,.7);background:#0d3a6e;transition:transform .15s,box-shadow .15s}}
    .hero-link-card:hover{{transform:translateY(-2px);box-shadow:0 12px 28px rgba(0,0,0,.48)}}
    .hero-link-card img{{width:100%;height:66px;object-fit:cover;display:block;opacity:.8}}
    .hero-link-card-overlay{{position:absolute;inset:0;background:linear-gradient(to top,rgba(9,26,49,.96) 0%,rgba(9,26,49,.32) 62%,rgba(9,26,49,.05) 100%);display:flex;flex-direction:column;justify-content:flex-end;padding:8px 12px 10px}}
    .hero-link-card-tag{{font-size:.58rem;text-transform:uppercase;letter-spacing:.06em;color:#e4c766;font-weight:800;margin-bottom:2px}}
    .hero-link-card-name{{font-family:"DM Serif Display",serif;font-size:.98rem;color:white;line-height:1.2;display:flex;align-items:center;gap:5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}}
    .hero-link-card-name span{{font-size:.8rem;color:#e4c766;flex-shrink:0}}
    @media(max-width:400px){{
      .hero-link-card{{width:132px;right:10px;bottom:10px}}
      .hero-link-card img{{height:54px}}
      .hero-link-card-name{{font-size:.86rem}}
    }}

    /* CONTAINER */
    .container{{max-width:980px;margin:0 auto;padding:20px 14px 50px}}
    @media(max-width:480px){{.container{{padding:14px 6px 40px}}}}
    ...
    /* ONGLETS — navigation coulissante horizontale, avec indice de scroll visible */
    .tab-nav-wrap{{position:relative;background:white;border-bottom:1px solid var(--border);box-shadow:0 2px 8px rgba(0,0,0,.04)}}
    .tab-nav{{display:flex;flex-wrap:nowrap;gap:2px;max-width:1240px;margin:0 auto;padding:0 2px;overflow-x:auto;scroll-behavior:smooth;-webkit-overflow-scrolling:touch;scrollbar-width:none}}
    .tab-nav::-webkit-scrollbar{{display:none}}
    .tab-btn{{flex:0 0 auto;min-width:88px;padding:12px 14px 10px;border:none;background:transparent;cursor:pointer;font-family:"DM Sans",sans-serif;font-size:.74rem;font-weight:700;color:var(--text-light);transition:color .15s,border-color .15s;letter-spacing:0;white-space:nowrap;border-bottom:3px solid transparent;text-align:center;line-height:1.2}}
    ...
    /* Indice visuel : dégradé + flèche animée tant qu'il reste du contenu à faire défiler */
    .tab-scroll-hint{{position:absolute;top:0;right:0;bottom:0;width:38px;display:none;align-items:center;justify-content:flex-end;pointer-events:none;background:linear-gradient(to right,rgba(255,255,255,0),rgba(255,255,255,.94) 55%);z-index:2}}
    .tab-scroll-hint.show{{display:flex}}
    .tab-scroll-hint span{{font-size:1rem;color:var(--blue-mid);margin-right:4px;animation:tabHintPulse 1.4s ease-in-out infinite}}
    .tab-nav-wrap.scrolled-end .tab-scroll-hint{{display:none}}
    @keyframes tabHintPulse{{0%,100%{{transform:translateX(0);opacity:.55}}50%{{transform:translateX(3px);opacity:1}}}}
    ...
    @media(max-width:480px){{.section{{padding:16px 11px}}}}
    ...
    @media(max-width:380px){{.piste-circles{{grid-template-columns:repeat(4,1fr);gap:4px}}}}
    ...
    .domaine-box{{
      display:block;text-decoration:none;color:inherit;margin:18px 0;border-radius:16px;overflow:hidden;
      position:relative;height:96px;border:1px solid #0d3a6e;
      box-shadow:0 6px 20px rgba(13,58,110,.26);transition:transform .15s,box-shadow .15s
    }}
    .domaine-box:hover{{transform:translateY(-2px);box-shadow:0 10px 28px rgba(13,58,110,.36)}}
    .domaine-box img{{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}}
    .domaine-box-overlay{{position:absolute;inset:0;background:linear-gradient(120deg,rgba(9,26,49,.9) 0%,rgba(13,58,110,.5) 55%,rgba(13,58,110,.25) 100%);display:flex;flex-direction:column;justify-content:center;padding:14px 22px}}
    .domaine-box-tag{{font-size:.66rem;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:#e4c766;margin-bottom:4px}}
    .domaine-box-name{{font-family:"DM Serif Display",serif;font-size:1.28rem;color:#fff;display:flex;align-items:center;gap:8px;text-shadow:0 2px 10px rgba(0,0,0,.35)}}
    .domaine-box-arrow{{font-size:1.05rem;color:#e4c766}}
    ...
    @media(max-width:480px){{.dt-hero{{padding:14px 13px}}}}
    ...
    .domaine-soeur-card{{
      display:block;position:relative;height:148px;border-radius:13px;overflow:hidden;text-decoration:none;
      transition:transform .15s,box-shadow .15s;box-shadow:0 3px 12px rgba(0,0,0,.14)
    }}
    .domaine-soeur-card:hover{{transform:translateY(-2px);box-shadow:0 8px 20px rgba(0,0,0,.22)}}
    .domaine-soeur-card img{{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}}
    .domaine-soeur-overlay{{position:absolute;inset:0;background:linear-gradient(to top,rgba(13,34,64,.94) 0%,rgba(13,34,64,.4) 55%,rgba(13,34,64,.08) 100%);display:flex;flex-direction:column;justify-content:flex-end;padding:12px 14px}}
    .domaine-soeur-name{{font-weight:800;color:#fff;font-size:.95rem;margin-bottom:5px;text-shadow:0 1px 6px rgba(0,0,0,.4)}}
    .domaine-soeur-stats{{display:flex;gap:10px;font-size:.72rem;color:rgba(255,255,255,.88);margin-bottom:5px}}
    .domaine-soeur-sub{{font-size:.72rem;color:#e4c766;font-weight:700}}
    ...
    .mobile-bar-btn{{
      flex:1;position:relative;overflow:hidden;border-radius:13px;padding:0;
      height:58px;border:1.5px solid rgba(212,175,55,.55);cursor:pointer;
      font-family:"DM Sans",sans-serif;text-decoration:none;display:block;
      box-shadow:0 4px 14px rgba(0,0,0,.18)
    }}
    .mobile-bar-btn img{{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}}
    .mobile-bar-btn-overlay{{
      position:relative;z-index:1;height:100%;display:flex;align-items:center;
      justify-content:center;gap:6px;font-weight:800;font-size:.86rem;color:white;
      text-shadow:0 1px 5px rgba(0,0,0,.55)
    }}
    .mobile-bar-official .mobile-bar-btn-overlay{{background:linear-gradient(rgba(9,26,49,.4),rgba(9,26,49,.72))}}
    .mobile-bar-booking .mobile-bar-btn-overlay{{background:linear-gradient(rgba(0,53,128,.5),rgba(0,53,128,.8))}}

    /* BOUTON SITE OFFICIEL */
    .official-btn{{
      width:100%;border:2px solid #d4af37;border-radius:var(--radius);
      padding:0;cursor:pointer;overflow:hidden;
      margin-bottom:16px;position:relative;
      box-shadow:0 8px 26px rgba(13,34,64,.3);
      display:block;min-height:132px;
      transition:transform .15s,box-shadow .15s
    }}
    .official-btn:hover{{transform:translateY(-2px);box-shadow:0 12px 34px rgba(13,34,64,.4)}}
    .official-btn-bg{{
    ...
    .official-btn-bg::after{{
      ...
      background:linear-gradient(160deg,rgba(9,26,49,.94) 0%,rgba(13,58,110,.86) 100%);
    }}
    .official-btn-badge{{
      position:absolute;top:12px;right:12px;z-index:2;
      background:#e4c766;color:#0d3a6e;font-weight:800;font-size:.62rem;
    ...
    .official-btn-title{{
      font-family:"DM Serif Display",serif;font-size:1.2rem;line-height:1.25;
    }}
    .official-btn-cta{{
      display:inline-flex;align-items:center;gap:5px;margin-top:10px;
      background:#e4c766;color:#0d3a6e;font-weight:800;font-size:.8rem;
  ...
  <div class="main-grid">
    ...
    <div>
      ...
      <div class="tab-content" id="tab-pourqui">
        ...
        <div class="section" style="margin-bottom:0;border-left:4px solid var(--blue-mid);background:linear-gradient(135deg,var(--white) 0%,var(--blue-light) 100%);--rm-bg:var(--blue-light)">
...
{gallery_html}
    ...
    <div class="sidebar">
      ...
      <button onclick="showOfficialSheet()" class="official-btn">
        <div class="official-btn-bg" style="background-image:url('{photo}')"></div>
        ...
        <div class="official-btn-content">
          ...
          <div class="official-btn-title">Site officiel de {s['name']}</div>
...
<div class="mobile-bar">
  <button onclick="showOfficialSheet()" class="mobile-bar-btn mobile-bar-official">
    ...
    <span class="mobile-bar-btn-overlay">🎿 Site officiel</span>
  </button>
  <a href="{booking_url}" target="_blank" rel="noopener sponsored" class="mobile-bar-btn mobile-bar-booking">
    <img src="../img/chalet-booking.jpg" alt="" loading="lazy" onerror="this.src='https://images.unsplash.com/photo-1502784444187-359ac186c5bb?w=400&q=80'">
    <span class="mobile-bar-btn-overlay">🏨 Réserver</span>
  </a>
</div>
...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  html,body{{touch-action:pan-x pan-y;overflow-x:hidden;max-width:100%}}
  body{{font-family:"DM Sans",sans-serif;color:var(--text);background:linear-gradient(135deg,#e8f3fb 0%,#d0e7f5 50%,#e8f3fb 100%);background-attachment:fixed;min-height:100vh;padding-top:58px;padding-bottom:76px}}
  a{{color:inherit}}
  /* BARRE DU HAUT — identique aux fiches station */
  .sf-topbar{{position:fixed;top:0;left:0;right:0;height:58px;background:rgba(255,255,255,.96);backdrop-filter:blur(6px);border-bottom:2px solid var(--wood-light);display:flex;align-items:center;justify-content:space-between;padding:0 14px;z-index:600;transition:transform .28s ease;overflow:visible}}
  .sf-topbar.sf-hide{{transform:translateY(-100%)}}
  .sf-topbar-logo{{display:flex;align-items:center;gap:7px;text-decoration:none;flex-shrink:0}}
  .sf-topbar-logo img{{width:42px;height:42px;border-radius:10px;object-fit:contain;box-shadow:0 4px 12px rgba(0,0,0,.18);background:white;flex-shrink:0}}
  ...
  .dm-fav{{position:absolute;top:16px;left:16px;z-index:20;background:rgba(255,255,255,.92);backdrop-filter:blur(8px);
    border:2px solid #ffd451;border-radius:50%;width:46px;height:46px;display:flex;align-items:center;justify-content:center;
    cursor:pointer;font-size:1.35rem;transition:all .2s;box-shadow:0 4px 14px rgba(0,0,0,.25);color:#d49b00}}
  ...
  .dm-compare{{position:absolute;top:16px;left:70px;z-index:20;background:rgba(255,255,255,.92);backdrop-filter:blur(8px);
    border:2px solid #3a7db8;border-radius:50%;width:46px;height:46px;display:flex;align-items:center;justify-content:center;
    cursor:pointer;font-size:1.15rem;transition:all .2s;box-shadow:0 4px 14px rgba(0,0,0,.25);color:#1a5a8a}}
  .dm-compare:hover{{background:#eaf4ff;border-color:#1a5a8a;transform:scale(1.08)}}
  .dm-compare.active{{background:#1a5a8a;border-color:#0d3a6e;box-shadow:0 4px 16px rgba(26,90,138,.5)}}
...
{dm_carousel_slides_html}
  ...
  <button class="dm-compare" id="dmCompare" type="button" aria-label="Ajouter au comparateur">⚖️</button>
<script>
// ── Favoris & comparateur DOMAINES — script autonome, indépendant du reste du hero ──
// (clés séparées des favoris/comparateur stations : sf_fav_domaines / sf_compare_domaines)
(function(){{
  var DOM_SLUG = "{slug}";
  function domFavs(){{try{{return JSON.parse(localStorage.getItem('sf_fav_domaines')||'[]');}}catch(e){{return [];}}}}
  function saveDomFavs(f){{try{{localStorage.setItem('sf_fav_domaines',JSON.stringify(f));}}catch(e){{}}}}
  function domCompares(){{try{{return JSON.parse(localStorage.getItem('sf_compare_domaines')||'[]');}}catch(e){{return [];}}}}
  function saveDomCompares(c){{try{{localStorage.setItem('sf_compare_domaines',JSON.stringify(c));}}catch(e){{}}}}
  ...
  function renderDomCompare(){{
    var b=document.getElementById('dmCompare');
    if(!b)return;
    var on=domCompares().indexOf(DOM_SLUG)!==-1;
    b.classList.toggle('active',on);
    b.title=on?'Retirer du comparateur':'Ajouter au comparateur';
  }}
  var favBtn=document.getElementById('dmFav');
  ...
  if(cmpBtn) cmpBtn.addEventListener('click',function(){{
    var c=domCompares(),i=c.indexOf(DOM_SLUG);
    if(i===-1){{
      if(c.length>=3){{alert("Vous pouvez comparer 3 domaines maximum. Retirez-en un avant d'en ajouter un nouveau.");return;}}
      c.push(DOM_SLUG);
    }}else{{c.splice(i,1);}}
...
// (Favoris & comparateur domaines : voir le script autonome juste après les
// boutons dans le hero, plus haut — indépendant de ce bloc.)
...
PAYS_CODE = {"France": "FR", "Suisse": "CH", "Italie": "IT", "Espagne": "ES", "Andorre": "AD", "Allemagne": "DE", "Liechtenstein": "LI", "Autriche": "AT", "Slovénie": "SI"}
...
# ── Bandeau du site (identique à index.html) ─────────────────────────────────
# Appliqué à chaque page générée juste avant l'écriture : remplace l'ancien
# petit bandeau (logo + app + ⭐) par le bandeau complet de l'accueil
# (logo + slogan, « L'app est dispo ! », ⚖️, ⭐, menu ☰ avec contact / notifs /
# mentions légales). Les compteurs restent gérés par le script de chaque page.
import re as _re_topbar
SF_TOPBAR_STYLE = r'''<style>
body{padding-top:64px!important}
.sf-topbar{position:fixed;top:0;left:0;right:0;height:64px;background:rgba(255,255,255,.96);backdrop-filter:blur(6px);border-bottom:2px solid #eddcbf;display:grid;grid-template-columns:auto 1fr auto;align-items:center;padding:0 6px;z-index:600;transition:transform .28s ease;overflow:visible;gap:8px;font-family:'DM Sans',sans-serif;box-sizing:border-box}
.sf-topbar *{box-sizing:border-box}
.sf-topbar.sf-hide{transform:translateY(-100%);}
.sf-topbar-logo{display:flex;align-items:center;gap:4px;text-decoration:none;flex-shrink:0;justify-self:start;min-width:0;}
.sf-topbar-logo img{width:60px;height:60px;border-radius:12px;object-fit:contain;flex-shrink:0}
.sf-topbar-wordtext{display:flex;flex-direction:column;justify-content:center;line-height:1.05;min-width:0;overflow:hidden}
.sf-topbar-title{font-family:"DM Serif Display",serif;font-size:.95rem;font-weight:700;white-space:nowrap}
.sf-topbar-title .sf-dark{color:#1a5a8a}
.sf-topbar-title .sf-light{color:#3a7db8}
.sf-topbar-slogan{font-size:.5rem;letter-spacing:.03em;color:#1a5a8a;opacity:.7;white-space:nowrap;text-transform:uppercase;margin-top:1px}
.sf-topbar-app{display:flex;align-items:center;gap:4px;background:linear-gradient(135deg,#e8f3fb,#eaf4ff);border:1px solid #3a7db8;border-radius:14px;padding:4px 9px;font-size:.64rem;font-weight:700;color:#1a5a8a;text-decoration:none;white-space:nowrap;box-shadow:0 2px 8px rgba(58,125,184,.18);justify-self:end;}
.sf-topbar-right{display:flex;align-items:center;justify-self:end;flex-shrink:0;}
.sf-topbar-fav{display:flex;align-items:center;gap:4px;text-decoration:none;color:#1a5a8a;font-weight:700;font-size:.85rem;flex-shrink:0;padding:5px 9px;border-radius:16px}
.sf-topbar-fav:active{background:#f7efe2}
.sf-topbar-menu{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:10px;border:1.5px solid #eddcbf;background:#fff;font-size:1rem;line-height:1;color:#1a5a8a;cursor:pointer;flex-shrink:0;padding:0;margin-left:2px}
.sf-topbar-menu:active{background:#f7efe2}
@media(max-width:480px){.sf-topbar{padding:0 4px;gap:4px}.sf-topbar-logo img{width:52px;height:52px}.sf-topbar-app{font-size:.58rem;padding:4px 7px}}
/* Menu rapide + notifications */
.sf-sheet-overlay{display:none;position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:9000;backdrop-filter:blur(4px)}
.sf-sheet-overlay.open{display:block}
.sf-sheet{position:fixed;left:0;right:0;bottom:0;z-index:9001;background:#f5f1ec;border-radius:20px 20px 0 0;padding:10px 0 max(20px,env(safe-area-inset-bottom));box-shadow:0 -8px 40px rgba(0,0,0,.2);transform:translateY(100%);transition:transform .32s cubic-bezier(.32,.72,0,1);max-width:480px;margin:0 auto;font-family:'DM Sans',sans-serif;box-sizing:border-box}
.sf-sheet.open{transform:translateY(0)}
.sf-sheet-handle{width:40px;height:4px;background:#ddd;border-radius:3px;margin:0 auto 10px}
.sf-sheet-title{text-align:center;font-family:"DM Serif Display",serif;font-size:1.05rem;color:#1a5a8a;margin-bottom:6px;padding:0 20px}
.sf-menu-item{display:flex;align-items:center;gap:12px;width:100%;padding:15px 24px;background:none;border:none;border-top:1px solid #f7efe2;font-size:.95rem;font-weight:600;color:#2a1f14;text-decoration:none;cursor:pointer;text-align:left;font-family:"DM Sans",sans-serif;box-sizing:border-box}
.sf-menu-item:active{background:#f7efe2}
.sf-menu-item .em{font-size:1.15rem;flex-shrink:0}
</style>'''
SF_TOPBAR_HTML = r'''<div class="sf-topbar" id="sfTopbar">
  <a href="/index.html" class="sf-topbar-logo">
    <img src="/logo.png" alt="SnowFinder">
    <span class="sf-topbar-wordtext">
      <span class="sf-topbar-title"><span class="sf-dark">Snow</span><span class="sf-light">Finder</span></span>
      <span class="sf-topbar-slogan">Comparez • Trouvez • Skiez</span>
    </span>
  </a>
  <a href="https://play.google.com/store/apps/details?id=fr.snowfinder.twa" class="sf-topbar-app" style="position:relative;left:12px">📲 L'app est dispo !</a>
  <div class="sf-topbar-right">
    <a href="/comparateur.html" class="sf-topbar-fav" style="margin-right:2px;position:relative;left:10px">⚖️ <span id="sfCompareCount">0</span></a>
    <a href="/favoris.html" class="sf-topbar-fav">⭐ <span id="sfFavCount">0</span></a>
    <button type="button" class="sf-topbar-menu" id="sfMenuBtn" onclick="openSfMenu()" aria-label="Menu">☰</button>
  </div>
</div>
'''
SF_TOPBAR_MENU = r'''<div class="sf-sheet-overlay" id="sfMenuOverlay" onclick="closeSfMenu()"></div>
<div class="sf-sheet" id="sfMenuSheet">
  <div class="sf-sheet-handle"></div>
  <div class="sf-sheet-title">Menu</div>
  <button type="button" class="sf-menu-item" onclick="closeSfMenu();openContact()"><span class="em">📧</span><span>Nous contacter</span></button>
  <button type="button" class="sf-menu-item" onclick="closeSfMenu();openSfNotif()"><span class="em">🔔</span><span>Notifications</span></button>
  <a class="sf-menu-item" href="/mentions-legales.html"><span class="em">⚖️</span><span>Mentions légales</span></a>
</div>

<div class="sf-sheet-overlay" id="sfNotifOverlay2" onclick="closeSfNotif()"></div>
<div class="sf-sheet" id="sfNotifSheet2" style="text-align:center">
  <div class="sf-sheet-handle"></div>
  <div style="padding:8px 24px 4px">
    <div style="font-size:2.3rem;margin-bottom:8px">🔔</div>
    <div style="font-family:'DM Serif Display',serif;font-size:1.25rem;color:#1a3f6e;margin-bottom:8px;line-height:1.2">Alertes poudreuse & bons plans ?</div>
    <p style="font-size:.88rem;color:#5c4a35;line-height:1.6;margin-bottom:16px">Reçois une alerte quand ça tombe fort, ou les bons plans forfaits. <strong>Gratuit, discret, 1 à 2 fois/semaine max.</strong></p>
  </div>
  <div style="padding:0 20px;display:flex;flex-direction:column;gap:10px">
    <button type="button" onclick="acceptSfNotif()" style="background:linear-gradient(135deg,#1a5a8a,#3a7db8);color:white;border:none;border-radius:30px;padding:15px;font-size:.95rem;font-weight:700;cursor:pointer;font-family:'DM Sans',sans-serif;box-shadow:0 4px 16px rgba(26,90,138,.3)">⛷️ Oui, je veux être alerté !</button>
    <button type="button" onclick="closeSfNotif()" style="background:transparent;color:#8a7060;border:none;padding:8px;font-size:.85rem;cursor:pointer;font-family:'DM Sans',sans-serif">Non merci</button>
  </div>
</div>

<script>
function openSfMenu(){document.getElementById('sfMenuOverlay').classList.add('open');document.getElementById('sfMenuSheet').classList.add('open');document.body.style.overflow='hidden';}
function closeSfMenu(){document.getElementById('sfMenuOverlay').classList.remove('open');document.getElementById('sfMenuSheet').classList.remove('open');document.body.style.overflow='';}
// « Nous contacter » : ouvre la modale de contact de l'accueil
if (typeof openContact !== 'function') {
  window.openContact = function(){ window.location.href = '/index.html#contact'; };
}
function openSfNotif(){
  if(typeof Notification!=='undefined' && Notification.permission==='granted'){ alert('Les notifications sont déjà activées ✅'); return; }
  if(typeof Notification!=='undefined' && Notification.permission==='denied'){ alert("Les notifications sont bloquées dans les réglages de ton navigateur."); return; }
  document.getElementById('sfNotifOverlay2').classList.add('open');
  document.getElementById('sfNotifSheet2').classList.add('open');
  document.body.style.overflow='hidden';
}
function closeSfNotif(){
  document.getElementById('sfNotifOverlay2').classList.remove('open');
  document.getElementById('sfNotifSheet2').classList.remove('open');
  document.body.style.overflow='';
}
function acceptSfNotif(){
  closeSfNotif();
  function ask(){
    window.OneSignalDeferred = window.OneSignalDeferred || [];
    window.OneSignalDeferred.push(async function(OneSignal){ try{ await OneSignal.Notifications.requestPermission(); }catch(e){} });
  }
  if(window.OneSignal || document.querySelector('script[src*="OneSignalSDK"]')){ ask(); return; }
  var s=document.createElement('script');
  s.src='https://cdn.onesignal.com/sdks/web/v16/OneSignalSDK.page.js'; s.defer=true;
  document.head.appendChild(s);
  window.OneSignalDeferred = window.OneSignalDeferred || [];
  window.OneSignalDeferred.push(async function(OneSignal){
    await OneSignal.init({appId:"df4757f7-ed59-4973-8a3d-782547295c9c",safari_web_id:"web.onesignal.auto.5c6acdd7-2576-4d7e-9cb0-efba7bf8602e",serviceWorkerPath:"sw.js",notifyButton:{enable:false},welcomeNotification:{disable:true}});
    try{ await OneSignal.Notifications.requestPermission(); }catch(e){}
  });
}
</script>
'''
SF_TOPBAR_FULL = r'''<!-- ══ TOP BAR APP — identique à index.html (se cache au scroll vers le bas) ══ -->
<style>
body{padding-top:64px!important}
.sf-topbar{position:fixed;top:0;left:0;right:0;height:64px;background:rgba(255,255,255,.96);backdrop-filter:blur(6px);border-bottom:2px solid #eddcbf;display:grid;grid-template-columns:auto 1fr auto;align-items:center;padding:0 6px;z-index:600;transition:transform .28s ease;overflow:visible;gap:8px;font-family:'DM Sans',sans-serif;box-sizing:border-box}
.sf-topbar *{box-sizing:border-box}
...
<div class="sf-sheet-overlay" id="sfMenuOverlay" onclick="closeSfMenu()"></div>
<div class="sf-sheet" id="sfMenuSheet">
  <div class="sf-sheet-handle"></div>
  <div class="sf-sheet-title">Menu</div>
  <button type="button" class="sf-menu-item" onclick="closeSfMenu();openContact()"><span class="em">📧</span><span>Nous contacter</span></button>
...
// Masquer la barre au scroll vers le bas + compteurs favoris / comparateur
(function(){
  var bar = document.getElementById("sfTopbar");
  var lastY = window.scrollY, ticking = false;
  window.addEventListener("scroll", function(){
  ...
  function updateFavCount(){
    var favs = [];
    try { favs = JSON.parse(localStorage.getItem("sf_favorites")||"[]"); } catch(e){}
    var el = document.getElementById("sfFavCount"); if(el) el.textContent = favs.length;
  }
  function updateCompareCount(){
    var c = [];
    try { c = JSON.parse(localStorage.getItem("sf_compare")||"[]"); } catch(e){}
    var el = document.getElementById("sfCompareCount"); if(el) el.textContent = c.length;
  }
  updateFavCount(); updateCompareCount();
  window.addEventListener("storage", updateFavCount);
  window.addEventListener("storage", updateCompareCount);
  window.addEventListener("focus", updateFavCount);
  window.addEventListener("focus", updateCompareCount);
})();
</script>
<!-- ══ FIN TOP BAR ══ -->
'''
_SF_OLD_CSS = _re_topbar.compile(r'^\s*(\.sf-topbar|@media\(max-width:480px\)\{\.sf-topbar-logo span)')
...
def harmonize_topbar(page_html):
    ...
    if start == -1:
        b = page_html.index('>', page_html.index('<body')) + 1
        return page_html[:b] + '\n' + SF_TOPBAR_FULL + page_html[b:]
    page_html = '\n'.join(l for l in page_html.split('\n') if not _SF_OLD_CSS.match(l))
    start = page_html.find('<div class="sf-topbar" id="sfTopbar">')
    end = page_html.index('</div>', start) + len('</div>')
    return page_html[:start] + SF_TOPBAR_STYLE + '\n' + SF_TOPBAR_HTML + SF_TOPBAR_MENU + page_html[end:]
...
for dslug, d in DOMAINES.items():
    try:
        ...
        with open(os.path.join(domaines_dir, f'{dslug}.html'), 'w', encoding='utf-8') as f:
            f.write(harmonize_topbar(dhtml))
        dcount += 1
    except Exception as e:
...
try:
    with open(os.path.join(root_dir, 'domaines.html'), 'w', encoding='utf-8') as f:
        f.write(harmonize_topbar(render_domaines_index()))
