...
DOMAINES = {
    "portes-du-soleil": {
        ...
        "pays": ["France", "Suisse"],
        "stations": ["Avoriaz","Morzine","Montriond","Les Gets","Saint-Jean-d'Aulps","Abondance","La Chapelle d'Abondance","Châtel","Torgon","Champéry - Les Crosets - Champoussin - Morgins"],
        "km_propre": {"Avoriaz":80,"Morzine":50,"Les Gets":120,"Châtel":85,
                       ...
                       "Torgon":19,"Champéry - Les Crosets - Champoussin - Morgins":100},
        "remontees_propre": {"Avoriaz":36},
        "alt_max_propre": {"Avoriaz":2200},
        "km_total": 624, "remontees_total": 243, "forfait_domaine": 58,
        "alt_min": 930, "alt_max": 2466,
        "pistes": {"v":50,"b":156,"r":125,"n":33},
    ...
    "espace-killy": {
        ...
        "km_total": 300, "remontees_total": 78, "forfait_domaine": 75,
        "alt_min": 1550, "alt_max": 3456,
        "pistes": {"v":21,"b":71,"r":42,"n":27},
    ...
    "paradiski": {
        ...
        "km_total": 520, "remontees_total": 157, "forfait_domaine": 68,
        "alt_min": 1200, "alt_max": 3250,
        "pistes": {"v":19,"b":157,"r":92,"n":42},
        "short": "Paradiski",
    ...
    "grand-massif": {
        ...
        "km_propre": {"Flaine":146,"Samoëns":67,"Les Carroz":38,"Morillon":25,"Sixt-Fer-à-Cheval":15},
        "km_total": 291, "remontees_total": 63, "forfait_domaine": 51,
        "alt_min": 700, "alt_max": 2500,
        "pistes": {"v":22,"b":69,"r":48,"n":16},
        "short": "Grand Massif",
    ...
    "sybelles": {
        ...
        "stations": ["La Toussuire","Le Corbier","Saint-Sorlin-d'Arves","Saint-Jean-d'Arves","Les Bottières"],
        "km_propre": {},
        "km_total": 230, "remontees_total": 62, "forfait_domaine": 50,
        "alt_min": 1100, "alt_max": 2620,
        "pistes": {"v":26,"b":56,"r":51,"n":13},
        "short": "Les Sybelles",
        "desc": "Six stations de Maurienne qui ont fusionné leurs domaines en 2003 autour du sommet de l'Ouillon, créant d'un coup l'un des plus grands domaines de France. La Toussuire, Le Corbier, Saint-Sorlin-d'Arves et Saint-Jean-d'Arves partagent le même forfait et les mêmes pistes — impossible de dire où commence l'une et où finit l'autre. C'est un domaine très ensoleillé, dominé par la silhouette des Aiguilles d'Arves, avec une majorité de pistes bleues et rouges qui en font un terrain idéal pour progresser en famille. ⚠️ Saint-Colomban-des-Villards, la sixième station historique, a perdu sa liaison skis-aux-pieds avec le reste des Sybelles à partir de l'hiver 2025/2026 (raisons économiques) et fonctionne désormais en domaine autonome avec forfait gratuit sur son front de neige — elle est donc sortie de ce domaine relié sur SnowFinder.",
    },
    "espace-diamant": {
        ...
        "km_propre": {"Les Saisies":77,"Praz-sur-Arly":30,"Crest-Voland":35,"Notre-Dame-de-Bellecombe":25,"Flumet":15,"Hauteluce":10},
        "km_total": 192, "remontees_total": 66, "forfait_domaine": 46,
        "alt_min": 910, "alt_max": 2069,
        "pistes": {"v":33,"b":66,"r":36,"n":7},
    ...
    "evasion-mont-blanc": {
        ...
        "km_propre": {"Megève":220,"Saint-Gervais":53,"Les Contamines-Montjoie":120,"Combloux":45,"La Giettaz":20},
        "km_total": 458, "remontees_total": 146, "forfait_domaine": 50,
        "alt_min": 850, "alt_max": 2353,
        "unifie": True,
        "pistes": {"v":60,"b":102,"r":106,"n":42},
        "short": "Évasion Mont-Blanc",
        "desc": "Megève, Saint-Gervais, Combloux, La Giettaz et Les Contamines-Montjoie, réunies au pied du toit de l'Europe. Megève, inventée dans les années 20 par la baronne de Rothschild qui voulait un Saint-Moritz français, reste la station de l'élégance à la française : village médiéval, calèches, tables étoilées. Le ski y est plutôt doux, sur de longues pistes en forêt à l'exposition généreuse. Attention à une subtilité : sur les 445 km annoncés par le forfait, une partie seulement est réellement reliée skis aux pieds — Les Contamines nécessite un transfert, et Megève/Combloux/La Giettaz se partagent des massifs communs (Rochebrune-Mont d'Arbois côté Megève-Saint-Gervais, Portes du Mont-Blanc côté Combloux-Giettaz) qui ne se répartissent pas proprement station par station. Le panorama sur le Mont-Blanc, lui, est constant.",
    },
    "espace-san-bernardo": {
        "name": "Espace San Bernardo", "massif": "Alpes du Nord",
        "pays": ["France", "Italie"],
        "stations": ["La Rosière","La Thuile"],
        "km_propre": {"La Rosière": 65, "La Thuile": 78},
        "km_total": 143, "remontees_total": 38, "forfait_domaine": 54,
        "alt_min": 1190, "alt_max": 2800,
        "pistes": {"v":22,"b":35,"r":18,"n":5},
    ...
    "galibier-thabor": {
        ...
        "km_propre": {"Valloire":90,"Valmeinier":70},
        "km_total": 160, "remontees_total": 29, "forfait_domaine": 54,
        "alt_min": 1430, "alt_max": 2750,
        "pistes": {"v":17,"b":31,"r":33,"n":8},
    ...
    "alpe-dhuez-grand-domaine": {
        ...
        "km_total": 250, "remontees_total": 81, "forfait_domaine": 62,
        "alt_min": 1135, "alt_max": 3330,
        "unifie": True,
        "pistes": {"v":34,"b":31,"r":28,"n":18},
        "short": "Alpe d'Huez",
        "desc": "L'Alpe d'Huez se surnomme l'Île au Soleil, et elle ne ment pas : 300 jours d'ensoleillement par an sur un plateau exposé plein sud, à 1860 m. Le domaine grimpe jusqu'au Pic Blanc à 3330 m, d'où part la Sarenne — 16 km de descente, la plus longue piste noire d'Europe, qui rejoint le fond de la vallée dans un décor de gorges sauvages. Autour de la station-mère gravitent Auris, Oz, Vaujany et Villard-Reculas, villages plus tranquilles et souvent moins chers, tous reliés. Les 21 virages de la montée mythique du Tour de France sont juste en dessous. Seuls Alpe d'Huez et Auris-en-Oisans sont référencés individuellement sur SnowFinder à ce jour ; Oz-en-Oisans, Vaujany, Villard-Reculas et Huez n'ont pas encore de fiche dédiée.",
    },
    "serre-chevalier-vallee": {
        "name": "Serre Chevalier Vallée", "massif": "Alpes du Sud", "pays": ["France"],
        "stations": ["Serre Chevalier"],
        "km_propre": {"Serre Chevalier": 250},
        "km_total": 250, "remontees_total": 59, "forfait_domaine": 63,
        "alt_min": 1200, "alt_max": 2830,
        "pistes": {"v":15,"b":26,"r":28,"n":13},
    ...
    "voie-lactee": {
        ...
        "pays": ["France", "Italie"],
        "stations": ["Montgenèvre","Sestrière","Sauze d'Oulx","Sansicario"],
        "km_propre": {"Montgenèvre": 95, "Sestrière": 114, "Sauze d'Oulx": 120, "Sansicario": 60},
        "km_total": 389, "remontees_total": 84, "forfait_domaine": 57,
        "alt_min": 1380, "alt_max": 2840,
        "unifie": True,
        "pistes": {"v":14,"b":85,"r":105,"n":29},
        "short": "La Voie Lactée",
        "desc": "Montgenèvre côté français, puis Sestrière, Sauze d'Oulx et Sansicario côté italien (Claviere et Cesana Torinese complètent le domaine mais ne sont pas encore référencées sur SnowFinder) — 400 km de pistes annoncés au total sur la Via Lattea. Fondée en 1907, Montgenèvre est l'une des toutes premières stations de ski de France, installée sur un col à 1860 m qui garantit un enneigement précoce. Sestrière, née en 1934 sous l'impulsion de la famille Agnelli, est le cœur historique et la plus grande station du domaine côté italien, site des JO de Turin 2006 comme Sauze d'Oulx (ski acrobatique) et Sansicario (vitesse dames). L'ambiance est franchement méridionale, avec le soleil du Briançonnais et de la Val Susa qui se sent partout, du menu des refuges à l'accent des remontées.",
    },
    "foret-blanche": {
        "name": "La Forêt Blanche", "massif": "Alpes du Sud", "pays": ["France"],
        "stations": ["Vars","Risoul"],
        "km_propre": {"Vars":100,"Risoul":85},
        "km_total": 185, "remontees_total": 42, "forfait_domaine": 46,
        "alt_min": 1650, "alt_max": 2750,
        "pistes": {"v":18,"b":49,"r":38,"n":10},
    ...
    "grand-tourmalet": {
        ...
        "stations": ["Grand Tourmalet"],
        "km_propre": {"Grand Tourmalet": 100},
        "km_total": 100, "remontees_total": 30, "forfait_domaine": 46,
        "alt_min": 1250, "alt_max": 2500,
        "pistes": {"v":17,"b":23,"r":21,"n":6},
    ...
    "grand-domaine-valmorel": {
        ...
        "km_total": 165, "remontees_total": 49, "forfait_domaine": 58,
        "alt_min": 1200, "alt_max": 2550,
        "pistes": {"v":25,"b":49,"r":21,"n":8},
    ...
    "le-devoluy": {
        ...
        "km_propre": {"Superdévoluy":55,"La Joue du Loup":45},
        "km_total": 100, "remontees_total": 22, "forfait_domaine": 40,
        "alt_min": 1500, "alt_max": 2500,
        "pistes": {"v":9,"b":22,"r":17,"n":5},
        "short": "Le Dévoluy",
    ...
    "espace-lumiere": {
        ...
        "km_propre": {"Pra-Loup":100,"Val d'Allos":80},
        "km_total": 180, "remontees_total": 37, "forfait_domaine": 47,
        "alt_min": 1500, "alt_max": 2600,
        "pistes": {"v":11,"b":27,"r":34,"n":8},
    ...
    "grand-sancy": {
        ...
        "km_total": 84, "remontees_total": 32, "forfait_domaine": 43,
        "alt_min": 1050, "alt_max": 1850,
        "pistes": {"v":20,"b":23,"r":15,"n":7},
...
_ALT_VILLAGE = {
    ...
    "Grand Tourmalet":1250,"Peyragudes":1600,"Saint-Lary-Soulan":1680,
...
# ══════════════════════════════════════════════════════════════════
# CONTRÔLE D'INTÉGRITÉ — Σ(stations membres) vs total du domaine
# ------------------------------------------------------------------
# Empêche le retour du bug « le domaine n'égale pas la somme de ses
# stations ». Tant qu'une station du domaine n'est pas vérifiée à la
# source (champ "ok" dans const DATA), l'écart est signalé sans être
# bloquant. Dès que TOUTES les stations d'un domaine sont vérifiées,
# tout écart devient une ERREUR.
# ══════════════════════════════════════════════════════════════════
def controle_integrite(DATA, DOMAINES):
    BY = {s['name']: s for s in DATA}
    dur = 0
    print("\n── Contrôle d'intégrité domaines ──")
    for slug, dom in DOMAINES.items():
        membres = [BY[n] for n in dom['stations'] if n in BY]
        manquants = [n for n in dom['stations'] if n not in BY]
        if manquants:
            print(f"  ERREUR {dom['short']}: station(s) introuvable(s) {manquants}")
            dur += 1
            continue
        if dom.get('unifie'):
            continue
        km = sum(m['km'] for m in membres)
        rm = sum(m['remontees'] for m in membres)
        pi = sum(sum(m['pistes'].values()) for m in membres)
        dp = dom.get('pistes') or {}
        ecart = (km != dom['km_total'] or rm != dom['remontees_total']
                 or (dp and pi != sum(dp.values())))
        toutes_ok = all(m.get('ok') for m in membres)
        if ecart and toutes_ok:
            print(f"  ERREUR {dom['short']}: Σ={km}km/{rm}rm/{pi}p  "
                  f"≠ total={dom['km_total']}km/{dom['remontees_total']}rm/{sum(dp.values())}p")
            dur += 1
        elif ecart:
            reste = [m['name'] for m in membres if not m.get('ok')]
            print(f"  ~ {dom['short']}: écart normal, {len(reste)} station(s) à vérifier")
        else:
            print(f"  OK {dom['short']}")
    if dur:
        sys.exit(f"\n{dur} incohérence(s) bloquante(s) — génération interrompue.")
    print("── Aucune incohérence bloquante ──\n")

controle_integrite(DATA, DOMAINES)
...
OFFICIAL_URLS = {
    ...
    "Orcières Merlette 1850":            "https://www.orcieres.com",
...
{carousel_dots_html}
    ...
    # ── Bandeau « station fermée » (fiche uniquement, jamais sur la vignette) ──
    # Le champ "ferme" de const DATA porte la saison concernée, ex. "2025/2026".
    # Formulation volontairement saisonnière : une réouverture reste possible.
    _f = s.get('ferme')
    fermeture_html = f'''<div class="station-fermee">
    <div class="sf-titre">⚠️ Station fermée pour la saison {_f}</div>
    <div class="sf-texte">Le domaine skiable n'a pas ouvert cet hiver. Une réouverture
    la saison suivante reste possible selon les conditions d'enneigement et
    les décisions de l'exploitant. Les chiffres ci-dessous décrivent le domaine
    en configuration d'exploitation normale.</div>
  </div>''' if _f else ''
...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    /* ONGLETS */
    .tab-nav-wrap{{position:relative;border-radius:14px 14px 0 0;background:var(--wood-pale);overflow:hidden}}
    .tab-nav{{display:flex;gap:6px;margin-bottom:0;flex-wrap:nowrap;max-width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;background:var(--wood-pale);border-radius:14px 14px 0 0;padding:10px 10px 0;border:1px solid var(--border);border-bottom:none}}
    .tab-nav::-webkit-scrollbar{{display:none}}
    .tab-nav-wrap::after{{content:'';position:absolute;top:0;right:0;bottom:0;width:28px;background:linear-gradient(to right,transparent,var(--wood-pale) 75%);border-radius:0 14px 0 0;pointer-events:none;opacity:1;transition:opacity .2s}}
    .tab-nav-wrap.scrolled-end::after{{opacity:0}}
    .tab-btn{{flex:0 0 auto;padding:10px 15px;border:1.5px solid var(--border);background:white;cursor:pointer;font-family:"DM Sans",sans-serif;font-size:.8rem;font-weight:700;color:var(--text-mid);border-radius:10px 10px 0 0;border-bottom:none;transition:all .15s;letter-spacing:.01em;white-space:nowrap;box-shadow:0 -1px 3px rgba(0,0,0,.03)}}
    .tab-btn.active{{background:var(--blue-mid);color:white;border-color:var(--blue-mid)}}
    .tab-btn:hover:not(.active){{background:var(--blue-light);color:var(--blue-dark);border-color:var(--blue)}}
    ...
    .tab-scroll-hint{{display:none;align-items:center;justify-content:center;gap:4px;font-size:.68rem;color:var(--text-light);padding:6px 0 2px;text-align:center}}
    @media(max-width:640px){{.tab-scroll-hint.show{{display:flex}}}}
    ...
    /* SECTIONS */
    .section{{background:var(--white);border-radius:var(--radius);padding:24px 28px;min-width:0;margin-bottom:16px;box-shadow:0 2px 10px rgba(0,0,0,.05);border:1px solid var(--wood-light)}}
    ...
    .station-fermee{{background:#fff4e5;border:1.5px solid #f0b429;border-left:5px solid #f0b429;border-radius:12px;padding:16px 18px;margin:0 0 20px}}
.sf-titre{{font-family:"DM Sans",sans-serif;font-weight:700;font-size:1rem;color:#8a5a00;margin-bottom:6px}}
.sf-texte{{font-size:.88rem;line-height:1.55;color:#6b4a05}}
.domaine-box{{
...
<div class="container">
  ...
  <div class="main-grid">
    ...
    <div>
      ...
      <div class="tab-scroll-hint" id="tabScrollHint">← glissez pour voir tous les onglets →</div>
...
def render_domaine_page(slug, d):
    ...
    # ── Photos du domaine : mêmes règles que pour les stations ──
    # Photos perso détectées sur disque (img/{slug-sans-tirets}N.jpg), sinon
    # 1 placeholder Unsplash choisi de façon déterministe (jamais de hero vide).
    domaine_photos = get_domaine_photos(slug)
    dm_carousel_sources = domaine_photos if domaine_photos else [pick_placeholder(d['name'], w=1400)]
...
def render_domaines_index():
    ...
    for slug, d in sorted(DOMAINES.items(), key=lambda x: -x[1]['km_total']):
        ...
        # Photo de vignette : même règle que les fiches (perso sinon Unsplash déterministe)
        dom_photos = get_domaine_photos(slug)
        dom_thumb = dom_photos[0] if dom_photos else pick_placeholder(d['name'], w=700)
...
# ══════════════════════════════════════════════════════════════════
# PAGES DE REDIRECTION — anciennes URL des stations fusionnées
# ------------------------------------------------------------------
# GitHub Pages ne permet pas de 301 côté serveur. On garde donc les
# anciens fichiers, qui répondent 200 et redirigent immédiatement.
# rel="canonical" transfère le référencement vers la fiche conservée.
# Aucune 404 n'est jamais servie.
# ══════════════════════════════════════════════════════════════════
FUSIONS_REDIR = [
    ("la-mongie-bareges-tourmalet", "grand-tourmalet",        "Grand Tourmalet"),
    ("saint-lary-village",          "saint-lary-soulan",      "Saint-Lary-Soulan"),
    ("orcieres-1850",               "orcieres-merlette-1850", "Orcières Merlette 1850"),
    ("orcieres-merlette",           "orcieres-merlette-1850", "Orcières Merlette 1850"),
    ("peisey-nancroix",             "peisey-vallandry",       "Peisey-Vallandry"),
    ("molines-saint-veran",         "molines-en-queyras",     "Molines-en-Queyras"),
    ("savoie-grand-revard",         "la-feclaz",              "La Féclaz"),
    ("peyresourde-balestas",        "peyragudes",             "Peyragudes"),
    ("monts-jura",                  "lelex-crozet",           "Lélex-Crozet"),
    ("kruth-wildenstein",           "le-frenz",               "Le Frenz"),
    ("bramont",                     "la-bresse-hohneck",      "La Bresse-Hohneck"),
    ("lamoura",                     "les-rousses",            "Les Rousses"),
    ("le-guery",                    "le-mont-dore",           "Le Mont Dore"),
    ("la-chaise-dieu",              "praboure",               "Prabouré"),
]

def generer_redirections():
    n = 0
    for ancien, nouveau, titre in FUSIONS_REDIR:
        cible = f"/stations/{nouveau}.html"
        html = f"""<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
<title>{titre} — SnowFinder</title>
<link rel="canonical" href="https://snowfinder.fr{cible}">
<meta name="robots" content="noindex,follow">
<meta http-equiv="refresh" content="0; url={cible}">
<script>window.location.replace("{cible}");</script>
<style>body{{font-family:'DM Sans',system-ui,sans-serif;background:#0f2942;color:#fff;
display:flex;align-items:center;justify-content:center;height:100vh;margin:0;text-align:center}}
a{{color:#7fc4f5}}</style>
</head>
<body><p>Cette fiche a été fusionnée.<br>
Redirection vers <a href="{cible}">{titre}</a>…</p></body>
</html>"""
        with open(f"stations/{ancien}.html", "w", encoding="utf-8") as f:
            f.write(html)
        n += 1
    print(f"✓ {n}/{len(FUSIONS_REDIR)} pages de redirection générées dans stations/")

generer_redirections()
if derrors:
