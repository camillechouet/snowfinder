...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  ...
  .dm-hero{{background:linear-gradient(135deg,var(--navy) 0%,#1a5a8a 100%);color:white;padding:38px 20px 30px;text-align:center;position:relative;overflow:hidden}}
  ...
  .dm-hero-overlay{{position:absolute;inset:0;z-index:1;background:linear-gradient(160deg,rgba(5,18,45,.72) 0%,rgba(13,58,110,.55) 55%,rgba(13,58,110,.35) 100%)}}
  .dm-hero>*:not(.hero-slides):not(.dm-hero-overlay){{position:relative;z-index:2}}
  ...
  .hero-dots{{position:absolute;bottom:10px;left:50%;transform:translateX(-50%);z-index:6;display:flex;gap:6px;background:rgba(0,0,0,.32);padding:5px 10px;border-radius:20px;backdrop-filter:blur(6px)}}
  .hero-dot{{width:7px;height:7px;border-radius:50%;background:rgba(255,255,255,.45);border:none;cursor:pointer;padding:0;transition:background .2s,transform .2s}}
  .hero-dot.active{{background:white;transform:scale(1.3)}}
  ...
  .dm-hero h1{{font-family:"DM Serif Display",serif;font-size:2.1rem;margin-bottom:8px;line-height:1.15;text-shadow:0 2px 12px rgba(0,0,0,.35)}}
  .dm-hero p{{opacity:.92;font-size:.92rem;max-width:560px;margin:0 auto;text-shadow:0 1px 8px rgba(0,0,0,.3)}}
