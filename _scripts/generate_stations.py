...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .hero-content{{position:absolute;bottom:0;left:0;right:0;padding:28px 28px 32px;z-index:10;pointer-events:none}}
    .hero-massif{{
    ...
    /* Vignette "Grand domaine" — centrée verticalement sur le bord droit, à l'écart
       du texte (bas-gauche) et des badges note/fermeture (haut-droite), pour une
       mise en page à 4 zones équilibrée quelle que soit la largeur d'écran. */
    .hero-link-card{{position:absolute;top:50%;right:14px;transform:translateY(-50%);z-index:12;pointer-events:auto;width:168px;border-radius:14px;overflow:hidden;text-decoration:none;display:block;box-shadow:0 8px 22px rgba(0,0,0,.4);border:2px solid rgba(212,175,55,.7);background:#0d3a6e;transition:transform .15s,box-shadow .15s}}
    .hero-link-card:hover{{transform:translateY(-52%);box-shadow:0 12px 28px rgba(0,0,0,.48)}}
    ...
    @media(max-width:400px){{
      .hero-link-card{{width:132px;right:10px}}
