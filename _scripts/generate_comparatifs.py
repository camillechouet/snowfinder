...
.book-station {{ background:var(--wood-pale); border-radius:var(--radius); padding:18px; }}
.book-station h3 {{ margin:0 0 12px; color:var(--wood-dark); font-family:"DM Serif Display",serif; }}
...
.btn-expedia {{ background:#ffcc00; color:#003580; }}
.detail-link {{
  display:block; text-align:center; margin-top:14px; font-size:.85rem;
  ...
  <div class="book-grid">
    <div class="book-station">
      ...
      <div class="book-buttons">
        <a href="{booking_a}" target="_blank" rel="noopener sponsored" class="btn-booking">🏨 Booking</a>
        <a href="{expedia_a}" target="_blank" rel="noopener sponsored" class="btn-expedia">✈️ Expedia</a>
      </div>
    ...
    <div class="book-station">
      <h3>{b}</h3>
      <div class="book-buttons">
        <a href="{booking_b}" target="_blank" rel="noopener sponsored" class="btn-booking">🏨 Booking</a>
        <a href="{expedia_b}" target="_blank" rel="noopener sponsored" class="btn-expedia">✈️ Expedia</a>
      </div>
...
def expedia_url(station_name: str) -> str:
    city = station_name.replace("'", "").replace(" ", "%20")
    return (f"https://www.expedia.fr/go/hotel/search/Destination/"
...
def build_page(comp: dict, stations_db: dict) -> tuple[str, str]:
    ...
    html = PAGE_TEMPLATE.format(
        ...
        expedia_a=expedia_url(a), expedia_b=expedia_url(b),
        json_ld=json_ld,
    )
