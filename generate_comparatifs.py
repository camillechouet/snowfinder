...
─────────────────────────────────────
Génère les pages de comparaison entre stations populaires, plus un snippet
...
Sorties :
    /comparatifs/{slug}.html         (une page par comparatif)
...
COMPARAISONS = [
    ...
    # ── COMPARATIFS AJOUTÉS (session précédente) ──────────────────────────
    ...
    # ── COMPARATIFS AJOUTÉS (session en cours) ─────────────────────────────

    {
        "a": "Val d'Isère",
        "b": "Serre Chevalier",
        "img_a": "valdisere1",
        "img_b": "serrechevalier1",
        "teaser": (
            "Deux grands domaines, mais deux façons radicalement différentes de vivre ses vacances au ski. "
            "Val d'Isère, la référence sportive et prestige de Tarentaise. Serre Chevalier, le grand domaine "
            "ensoleillé et décontracté des Alpes du Sud, entre potes ou en famille."
        ),
        "profils": [
            ("🎿 Skieurs confirmés cherchant du terrain engagé", "Val d'Isère",
             "La Face de Bellevarde (JO d'Albertville 1992) et les couloirs du Solaise sont des références mondiales. Hors-piste réputé parmi les plus complets d'Europe."),
            ("👯 Groupe de potes pour un séjour convivial et sans prise de tête", "Serre Chevalier",
             "Longue vallée de villages reliés, ambiance décontractée, ski en forêt de mélèzes ensoleillée et bars accessibles à toute heure sans l'étiquette premium."),
            ("💰 Budget serré ou raisonnable", "Serre Chevalier",
             "Forfait journée autour de 65 € contre 75 € à Val d'Isère (domaine relié Tignes), et un hébergement nettement plus abordable sur toute la vallée."),
            ("✨ Séjour prestige / gastronomie étoilée", "Val d'Isère",
             "Plusieurs palaces 5 étoiles et une table étoilée au Guide Michelin (Les Barmes de l'Ours). Ambiance internationale haut de gamme assumée."),
            ("☀️ Amateurs de grand soleil", "Serre Chevalier",
             "300 jours de soleil par an revendiqués grâce à son exposition sud, entre Écrins et frontière italienne — un vrai plus pour les journées à rallonge en terrasse."),
            ("🌲 Ski en forêt / hors-piste tranquille", "Serre Chevalier",
             "Deux tiers du domaine sont couverts de mélèzes, ce qui garde la neige fraîche plus longtemps et offre un cadre de ski nettement plus doux que la haute altitude minérale de Val d'Isère."),
        ],
        "verdict": (
            "<strong>Val d'Isère</strong> est le choix des skieurs qui veulent du terrain technique, de l'altitude "
            "garantie et une ambiance chic assumée, avec le budget qui va avec. "
            "<strong>Serre Chevalier</strong> est parfaite pour un séjour convivial entre amis ou en famille, plus "
            "abordable, ensoleillé et sans prise de tête — un grand domaine sans l'étiquette prestige."
        ),
        "faq": [
            ("Val d'Isère ou Serre Chevalier : laquelle est la moins chère ?",
             "Serre Chevalier, nettement. Le forfait journée adulte tourne autour de 65 € contre 75 € à Val d'Isère (domaine relié avec Tignes), et l'hébergement y est en moyenne bien plus abordable — Val d'Isère compte parmi les stations les plus chères de France."),
            ("Serre Chevalier est-elle réputée pour le hors-piste ?",
             "Oui, la station est bien connue pour son ski en forêt de mélèzes et ses zones d'altitude propices au freeride, notamment autour du Monêtier-les-Bains. Val d'Isère reste toutefois une référence encore plus engagée sur ce terrain, avec un domaine hors-piste parmi les plus vastes des Alpes."),
            ("Quelle station a la meilleure ambiance pour un groupe d'amis ?",
             "Serre Chevalier, pour son ambiance décontractée sur toute la vallée et son budget plus souple. Val d'Isère se prête aussi très bien à un séjour entre amis, mais avec une ambiance plus premium et des additions qui suivent."),
            ("Val d'Isère et Serre Chevalier ont-elles un domaine skiable comparable en taille ?",
             "Oui, dans le même ordre de grandeur : 300 km pour l'Espace Killy (Val d'Isère + Tignes) contre 250 km pour Serre Chevalier Vallée, qui relie Briançon, Chantemerle, Villeneuve et Le Monêtier."),
        ],
    },
    {
        "a": "Les Gets",
        ...
        "img_b": "flaine1",
        "teaser": (
            "Deux stations de Haute-Savoie, deux univers totalement différents. Les Gets, village savoyard "
            "authentique et familial au cœur des Portes du Soleil. Flaine, station-œuvre d'art en béton brut "
            "signée Marcel Breuer, plus adaptée à un ski technique entre amis."
        ),
        "profils": [
            ("👨‍👩‍👧‍👦 Famille avec enfants", "Les Gets",
             "Village labellisé Famille Plus, chalets savoyards traditionnels, Musée de la Musique Mécanique et zones ludiques dédiées aux enfants."),
            ("👯 Groupe d'amis pour un ski technique et sans voiture", "Flaine",
             "Station piétonne skis aux pieds, secteurs plus exigeants (Combe de Gers), et une architecture qui donne le ton dès l'arrivée — le genre d'endroit qui marque un séjour entre potes."),
            ("🎿 Accès au plus grand domaine skiable", "Les Gets",
             "Porte d'entrée des Portes du Soleil, l'un des plus vastes domaines transfrontaliers d'Europe, contre un domaine plus resserré côté Grand Massif pour Flaine."),
            ("🖼️ Curiosité architecturale et artistique", "Flaine",
             "Sculptures monumentales de Picasso, Dubuffet et Vasarely disséminées dans la station, façades Bauhaus classées Patrimoine du XXe siècle. Une expérience unique en France."),
            ("🏘️ Charme du village savoyard", "Les Gets",
             "Chalets en bois, ambiance conviviale toute l'année, et une identité de vrai village plutôt que de station construite ex nihilo."),
            ("⛷️ Ski d'altitude fiable et technique", "Flaine",
             "Domaine culminant à 2 500 m, secteurs exigeants pour skieurs confirmés, praticité skis aux pieds au départ de chaque appartement."),
        ],
        "verdict": (
            "<strong>Les Gets</strong> est le choix évident pour une famille qui cherche un vrai village savoyard "
            "et l'accès à un domaine immense. <strong>Flaine</strong> conviendra davantage à un groupe d'amis en "
            "quête de ski technique, de praticité skis aux pieds et d'une expérience architecturale qu'on ne trouve "
            "nulle part ailleurs dans les Alpes."
        ),
        "faq": [
            ("Pourquoi Flaine a-t-elle une architecture si particulière ?",
             "Flaine a été conçue de toutes pièces à la fin des années 1960 par l'architecte Marcel Breuer, ancienne figure du Bauhaus, à l'initiative des mécènes Éric et Sylvie Boissonnas. Ses bâtiments en béton préfabriqué, aux façades en pointe de diamant, sont aujourd'hui reconnus comme patrimoine architectural du XXe siècle."),
            ("Y a-t-il vraiment des œuvres d'art à Flaine ?",
             "Oui, la station abrite plusieurs sculptures monumentales : une « Tête de femme » de Picasso, « Le Boqueteau des 7 arbres » de Jean Dubuffet et « Trois Hexagones » de Victor Vasarely, déposées par le Centre Pompidou. Une curiosité culturelle assez unique en station de ski."),
            ("Les Gets donnent-ils vraiment accès à un très grand domaine ?",
             "Oui, avec le forfait complet des Portes du Soleil, l'un des plus grands domaines skiables d'Europe reliant une douzaine de stations franco-suisses. En local, Les Gets partagent aussi un domaine propre d'environ 120 km avec Morzine."),
            ("Flaine est-elle adaptée aux familles malgré son ambiance différente ?",
             "Oui, c'est aussi une station pratique pour les familles grâce à son statut piétonnier et à son accès skis aux pieds. Mais l'ambiance générale, plus axée sur l'architecture et le ski technique, en fait une destination particulièrement appréciée des groupes d'amis et des skieurs confirmés."),
        ],
    },
]
...
<nav class="nav">
  ...
  <div class="navlinks">
    ...
    <a href="/comparatifs/tous-les-comparatifs.html">Comparatifs</a>
...
<div class="crumbs">
  <a href="/">Accueil</a> · <a href="/comparatifs/tous-les-comparatifs.html">Comparatifs</a> · {a} vs {b}
</div>
...
# Remplace l'ancienne petite nav des duels et de la page tous-les-comparatifs
# par le bandeau complet du site (logo, "L'app est dispo !", ⚖️, ⭐, menu ☰).
SF_TOPBAR = r'''<!-- ══ TOP BAR APP — identique à index.html (se cache au scroll vers le bas) ══ -->
<style>
...
def build_page(comp: dict, stations_db: dict) -> tuple[str, str]:
    ...
    return page_slug, add_topbar(html)
...
.comp-imgs {{ display:grid; grid-template-columns:1fr 1fr; height:160px; overflow:hidden; }}
.comp-imgs img {{ width:100%; height:100%; object-fit:cover; display:block; }}
.comp-body {{ padding:16px 18px; position:relative; z-index:1; background:#fff; }}
...
_build_index_sans_bandeau = build_index


def build_index(comparaisons_meta: list) -> str:
    return add_topbar(_build_index_sans_bandeau(comparaisons_meta))
...
{cards}
  ...
  <a href="/comparatifs/tous-les-comparatifs.html" class="all-link">Voir nos {total} comparatifs →</a>
</section>
...
def main() -> None:
    ...
    (COMPARATIFS_DIR / "tous-les-comparatifs.html").write_text(build_index(meta), encoding="utf-8")
    print(f"  → comparatifs/tous-les-comparatifs.html")
